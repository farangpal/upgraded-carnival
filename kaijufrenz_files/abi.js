var ABI = [
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_freemintRoot", type: "bytes32" },
    ],
    name: "setFreeMintRoot",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_presaleRoot", type: "bytes32" },
    ],
    name: "setPreSaleRoot",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "uint256", name: "_wlPrice", type: "uint256" }],
